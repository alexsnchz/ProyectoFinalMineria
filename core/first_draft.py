...
if __name__ == '__main__':
    ...
    utils.logger("FILLING MISSING VALUES WITH CONSTANT")
    ...
    utils.logger("REPLACING MISSING VALUES WITH CONSTANT")
    ...
    for i in range(len(numpy_data[0])):
        ...
        if i in nominal_columns:
            # utils.debug("Dict column %d: %s ", i, dict)
    ...
    for name, em_clf in zip(names, models):
        ...
        utils.debug('Total Error: %s', error)